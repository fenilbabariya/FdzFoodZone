...
{
    public partial class edit_drinks : System.Web.UI.Page
    {
        ...
        private void fetchData()
        {
            ...
            {
                //Card 1
                txtName1.Attributes["placeholder"] = DrinkName[0];
                txtPrice1.Attributes["placeholder"] = DrinkPrice[0];
                txtDescription1.Attributes["placeholder"] = DrinkDescription[0];
                Image1.ImageUrl = DrinkImage[0];
                //Card 2
                txtName2.Attributes["placeholder"] = DrinkName[1];
                txtPrice2.Attributes["placeholder"] = DrinkPrice[1];
                txtDescription2.Attributes["placeholder"] = DrinkDescription[1];
                Image2.ImageUrl = DrinkImage[1];
                //Card 3
                txtName3.Attributes["placeholder"] = DrinkName[2];
                txtPrice3.Attributes["placeholder"] = DrinkPrice[2];
                txtDescription3.Attributes["placeholder"] = DrinkDescription[2];
                Image3.ImageUrl = DrinkImage[2];
                //Card 4
                txtName4.Attributes["placeholder"] = DrinkName[3];
                txtPrice4.Attributes["placeholder"] = DrinkPrice[3];
                txtDescription4.Attributes["placeholder"] = DrinkDescription[3];
                Image4.ImageUrl = DrinkImage[3];
                //Card 5
                txtName5.Attributes["placeholder"] = DrinkName[4];
                txtPrice5.Attributes["placeholder"] = DrinkPrice[4];
                txtDescription5.Attributes["placeholder"] = DrinkDescription[4];
                Image5.ImageUrl = DrinkImage[4];
                //Card 6
                txtName6.Attributes["placeholder"] = DrinkName[5];
                txtPrice6.Attributes["placeholder"] = DrinkPrice[5];
                txtDescription6.Attributes["placeholder"] = DrinkDescription[5];
                Image6.ImageUrl = DrinkImage[5];
                //Card 7
                txtName7.Attributes["placeholder"] = DrinkName[6];
                txtPrice7.Attributes["placeholder"] = DrinkPrice[6];
                txtDescription7.Attributes["placeholder"] = DrinkDescription[6];
                Image7.ImageUrl = DrinkImage[6];
                //Card 8
                txtName8.Attributes["placeholder"] = DrinkName[7];
                txtPrice8.Attributes["placeholder"] = DrinkPrice[7];
                txtDescription8.Attributes["placeholder"] = DrinkDescription[7];
                Image8.ImageUrl = DrinkImage[7];
                //Card 9
                txtName9.Attributes["placeholder"] = DrinkName[8];
                txtPrice9.Attributes["placeholder"] = DrinkPrice[8];
                txtDescription9.Attributes["placeholder"] = DrinkDescription[8];
                Image9.ImageUrl = DrinkImage[8];
                //Card 10
                txtName10.Attributes["placeholder"] = DrinkName[9];
                txtPrice10.Attributes["placeholder"] = DrinkPrice[9];
                txtDescription10.Attributes["placeholder"] = DrinkDescription[9];
                Image10.ImageUrl = DrinkImage[9];
                //Card 11
                txtName11.Attributes["placeholder"] = DrinkName[10];
                txtPrice11.Attributes["placeholder"] = DrinkPrice[10];
                txtDescription11.Attributes["placeholder"] = DrinkDescription[10];
                Image11.ImageUrl = DrinkImage[10];
                //Card 12
                txtName12.Attributes["placeholder"] = DrinkName[11];
                txtPrice12.Attributes["placeholder"] = DrinkPrice[11];
                txtDescription12.Attributes["placeholder"] = DrinkDescription[11];
        ...
        private void updateDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update [Drinks] set Name='" + Name + "', Price='" + Price + "', Description='" + Description + "' where Id='" + Id + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void updateImage()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update [Drinks] set imglink='" + filepath + "' where Id='" + Id + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
